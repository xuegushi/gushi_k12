...
| macOS (Apple Silicon) | [下载 .dmg](https://github.com/xuegushi/gushi_k12/releases/tag/v0.1.10) |
| 桌面版 (v0.1.10) | [GitHub Releases](https://github.com/xuegushi/gushi_k12/releases/tag/v0.1.10) |
...
| 诗词填空 | 从形近字混淆的候选池选字填入诗句空白处 |
| 飞花令 | 输入包含指定主题字的诗句（8 类 158 个字库） |
| 诗词连连看 | 多首诗混合配对上下句，匹配后显示诗名 |
| 诗词拼图 | N×N 文字矩阵候选池，含干扰字，按原诗行填入 |
